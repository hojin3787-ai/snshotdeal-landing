        ...
        <div className="container mx-auto relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/pricing"
                className="inline-flex items-center justify-center bg-white hover:bg-gray-50 text-purple-600 font-bold px-8 py-4 rounded-xl text-base transition-all shadow-2xl hover:shadow-3xl hover:scale-105 transform"
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/pricing"
                className="inline-flex items-center justify-center bg-white hover:bg-gray-100 text-purple-600 font-semibold px-10 py-4 rounded-lg text-lg transition-colors shadow-lg hover:shadow-xl"
                style={{ paddingTop: '16px', paddingBottom: '16px' }}
              >
                가격 확인하기
              </Link>
